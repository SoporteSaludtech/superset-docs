...
| 🔑 | **`INDCOD`** | `char(6)` | NO | Campo transaccional de Hosvital HIS |
| 🔑 | **`INDPRCOD`** | `char(9)` | NO | Campo transaccional de Hosvital HIS |
|  | **`INDPRESP`** | `smallint` | SI | Campo transaccional de Hosvital HIS |
