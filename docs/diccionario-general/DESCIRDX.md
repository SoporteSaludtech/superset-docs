...
| 🔑 | **`CodDxPrPo`** | `char(5)` | NO | Campo transaccional de Hosvital HIS |
| 🔑 | **`CodTipDx`** | `char(1)` | NO | Campo transaccional de Hosvital HIS |
|  | **`CodObsDx`** | `varchar(MAX)` | SI | Campo transaccional de Hosvital HIS |
