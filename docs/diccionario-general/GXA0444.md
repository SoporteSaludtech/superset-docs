...
|  | **`TrcPrmNom`** | `char(12)` | SI | Campo transaccional de Hosvital HIS |
|  | **`TrcSegNom`** | `char(12)` | SI | Campo transaccional de Hosvital HIS |
|  | **`TrcPrmApe`** | `char(18)` | SI | Campo transaccional de Hosvital HIS |
|  | **`TrcSegApe`** | `char(18)` | SI | Campo transaccional de Hosvital HIS |
...
|  | **`TRCFECNAC`** | `datetime` | NO | Campo transaccional de Hosvital HIS |
|  | **`TRCSEX`** | `char(1)` | NO | Campo transaccional de Hosvital HIS |
