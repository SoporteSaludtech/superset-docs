...
- **Módulo de Origen:** Historia Clínica / Diagnósticos (`HCDIAGN`, `MAEDIA`, `HCCOM1`, `Ingresos`, `Capbas`)
- **Propósito:** Detección, aislamiento y seguimiento de infecciones asociadas a la atención en salud (IAAS) y patologías de interés en salud pública.
...
Mide la prevalencia de infecciones activas normalizada por los días de estancia acumulados:
...
- **Índice <= 3.0% (Controlado):** Comportamiento esperado dentro de los límites de control.
- **Índice > 3.0% (Alerta Temprana de Brote):** Requiere activación de rondas de bioseguridad, tipificación microbiológica y desinfección terminal.
