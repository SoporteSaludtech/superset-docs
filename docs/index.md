...
| **Arquitectura y Datos** | Guía de Despliegue en Clientes | Procedimiento de instalación Docker, blindaje de drivers SQL y persistencia visual | N/A | [Ver Guía](deployment/guia-despliegue-cliente.md) |
...
| **Gestión Asistencial** | Consola Oportunidad de Citas | Lead time de asignación, tasa de asistencia global y control de inasistencias por especialidad | Tiempo Real | [Ver Ficha Técnica](dashboards/16-consola-oportunidad-citas.md) |
| **Gestión Asistencial** | Consola de Gestión de Urgencias | Monitoreo de pacientes activos, ocupación física, carga por especialidad y tiempos de flujo en el servicio | Tiempo Real | [Ver Ficha Técnica](dashboards/17-consola-gestion-urgencias.md) |
...
| **Calidad y Auditoría** | Consola de Seguridad del Paciente (SOGCS) | Vigilancia epidemiológica y tipificación de incidentes, cuasi fallas y eventos adversos para análisis causal y comités PAMEC | Tiempo Real | [Ver Ficha Técnica](dashboards/18-consola-seguridad-paciente-sogcs.md) |
